...
/** This ABI function is called to register a function which will be called on
 * DSO unloading.
 */
ASMCALL int
 ...
 *
 * Call constructors for all static objects in the linked module. Used by low
 * level startup code.
 *
 ...
 *
 * Call destructors for all static objects in the linked module. Used by low
 * level cleanup code.
 *
 * @return Zero if success.
 */
