...
/* @(#) $Id: private.h 172 2010-12-13 07:54:26Z vagran $ */
...
struct Elf_s {
    ...
    unsigned e_free_syms :1; /* e_symtab is elf_malloc'ed */
...
struct Elf_Scn_s {
    ...
    /* misc flags */
    unsigned s_freeme :1; /* this Elf_Scn was elf_malloc'ed */
    /* section header */
    union {
#if __LIBELF64
        Elf64_Shdr u_shdr64;
...
struct Scn_Data {
    ...
    /* misc flags */
    unsigned sd_freeme :1; /* this Scn_Data was elf_malloc'ed */
    unsigned sd_free_data :1; /* sd_memdata is elf_malloc'ed */
    /* magic number for debugging */
    long sd_magic;
};
...
extern size_t _elf32_xltsize(const Elf_Data *__src, unsigned __dv,
    unsigned __encode, int __tof);
extern size_t _elf64_xltsize(const Elf_Data *__src, unsigned __dv,
    unsigned __encode, int __tof);
 ...
 * Special translators
 */
extern size_t _elf_verdef_32L11_tof(unsigned char *dst,
    const unsigned char *src, size_t n);
extern size_t _elf_verdef_32L11_tom(unsigned char *dst,
    const unsigned char *src, size_t n);
extern size_t _elf_verdef_32M11_tof(unsigned char *dst,
    const unsigned char *src, size_t n);
extern size_t _elf_verdef_32M11_tom(unsigned char *dst,
    const unsigned char *src, size_t n);
extern size_t _elf_verdef_64L11_tof(unsigned char *dst,
    const unsigned char *src, size_t n);
extern size_t _elf_verdef_64L11_tom(unsigned char *dst,
    const unsigned char *src, size_t n);
extern size_t _elf_verdef_64M11_tof(unsigned char *dst,
    const unsigned char *src, size_t n);
extern size_t _elf_verdef_64M11_tom(unsigned char *dst,
    const unsigned char *src, size_t n);
extern size_t _elf_verneed_32L11_tof(unsigned char *dst,
    const unsigned char *src, size_t n);
extern size_t _elf_verneed_32L11_tom(unsigned char *dst,
    const unsigned char *src, size_t n);
extern size_t _elf_verneed_32M11_tof(unsigned char *dst,
    const unsigned char *src, size_t n);
extern size_t _elf_verneed_32M11_tom(unsigned char *dst,
    const unsigned char *src, size_t n);
extern size_t _elf_verneed_64L11_tof(unsigned char *dst,
    const unsigned char *src, size_t n);
extern size_t _elf_verneed_64L11_tom(unsigned char *dst,
    const unsigned char *src, size_t n);
extern size_t _elf_verneed_64M11_tof(unsigned char *dst,
    const unsigned char *src, size_t n);
extern size_t _elf_verneed_64M11_tom(unsigned char *dst,
    const unsigned char *src, size_t n);
 ...
 */
#if ENABLE_DEBUG
extern void __elf_assert(const char*, unsigned, const char*);
# if (__STDC__ + 0)
