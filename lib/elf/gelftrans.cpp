...
gelf_getsym(Elf_Data *src, int ndx, GElf_Sym *dst)
{
    ...
    if (dst == &buf) {
        dst = (GElf_Sym*) elf_malloc(sizeof(GElf_Sym));
        if (!dst) {
...
gelf_getdyn(Elf_Data *src, int ndx, GElf_Dyn *dst)
{
    ...
    if (dst == &buf) {
        dst = (GElf_Dyn*) elf_malloc(sizeof(GElf_Dyn));
        if (!dst) {
...
gelf_getrela(Elf_Data *src, int ndx, GElf_Rela *dst)
{
    ...
    if (dst == &buf) {
        dst = (GElf_Rela*) elf_malloc(sizeof(GElf_Rela));
        if (!dst) {
...
gelf_getrel(Elf_Data *src, int ndx, GElf_Rel *dst)
{
    ...
    if (dst == &buf) {
        dst = (GElf_Rel*) elf_malloc(sizeof(GElf_Rel));
        if (!dst) {
