...
/** @file hash.h
 * This file contains implementation of Phoenix primary hash algorithm.
 */

#ifndef HASH_H_
#define HASH_H_

/** This class is the primary tool for calculating lookup (non-cryptographic)
 * hashes in Phoenix. It is based on Bob Jenkins hash algorithm (lookup3).
 */
class Hash {
public:
    /** Create hash object.
...
private:
     ...
     */
    void _Finalize(u32 &a, u32 &b, u32 &c);
};
