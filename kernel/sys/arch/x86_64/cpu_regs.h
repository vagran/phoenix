/*
 * /phoenix/kernel/sys/arch/x86_64/cpu_regs.h
 *
...
enum Cr4Bits {
    ...
    CR4_VMXE =      0x00002000, /**< VMX-Enable */
    CR4_SMXE =      0x00004000, /**< SMX-Enable */
    CR4_PCDIE =     0x00020000, /**< Enables process-context identifiers. */
};

/** Bits in values returned by @a cpuid instruction. */
enum CpuidBits {
    /*
...
enum Ia32eferBits {
    IA32_EFER_SCE =         0x001, /**< SysCall enable */
...
enum Pcr0Bits {
    ...
    PCR0_AIS =      0x08,   /**< Enables all instructions stalled to serialize pipe. */
 ...
 * These registers must be written as three separate bytes. @n
 *
 * NCRx+0: A31-A24 of starting address @n
 * NCRx+1: A23-A16 of starting address @n
 * NCRx+2: A15-A12 of starting address | NCR_SIZE_xx. @n
 *
 ...
 * size for the eight address regions. @n
 *
 * ARRx + 0: A31-A24 of start address @n
 * ARRx + 1: A23-A16 of start address @n
 * ARRx + 2: A15-A12 of start address | ARR_SIZE_xx @n
 */
enum ArrConsts {
    ARR0 =              0xc4,
    ARR1 =              0xc7,
