...
Abstract:
    ...
    Lib functions for SMBIOS. Used to get system serial number and GUID
    ...
    )
{
    ...
    Smbios.Hdr = (SMBIOS_HEADER *)(UINT64)SmbiosTable->TableAddress;
    SmbiosEnd.Raw = (UINT8 *)(UINT64)(SmbiosTable->TableAddress + SmbiosTable->TableLength);
